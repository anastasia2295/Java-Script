...
combine(showResult.bind(this, "The result after adding numbers is:"), "ADD", 5, 10, -3, 6, 10)
combine(showResult.bind(this, "The result after adding numbers is:"), "ADD", 5, 10, -3, 6, 10, 25, 88)
combine(showResult.bind(this, "The result after subtracting numbers is:"),"SUBTRACT", 1, 10, 15, 20)